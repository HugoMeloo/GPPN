...
<div class="container d-flex justify-content-center align-items-center vh-100" style="margin-right: 20px; margin-top: -90px;">
        <div class="register-box text-center p-4">
            <h1>Cadastrar Empresa</h1>
            <form action="/CadastrarEmpresa" method="post" enctype="multipart/form-data" class="container">
            ...
            <input type="hidden" name="id" id="id" value="${param.id}">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="telefone-empresa" name="telefone-empresa" placeholder="(DDD) Telefone" required>
                </div>
                ...
                <div class="form-group">
                            <label for="image-empresa" class="form-label">Escolha a foto da empresa</label>
